...
archer1 = pygame.image.load(os.path.join("asset", "archer1.png"))
archer2 = pygame.image.load(os.path.join("asset", "archer2.png"))
ratio_x = archer1.get_width()/archer2.get_width()
ratio_y = archer1.get_height()/archer2.get_height()
effect = pygame.mixer.Sound("05.wav")
...
archer_imgs1 = pygame.transform.scale(pygame.image.load(os.path.join("asset", "archer1.png")),(int(70*ratio_x), int(70*ratio_y)))
archer_imgs2 = pygame.transform.scale(pygame.image.load(os.path.join("asset", "archer2.png")),(70, 70))
            ...
            if self.archer_count == 30:
                if Enemy.is_hit(first_enemy, first_enemy.x, first_enemy.y) == True:
                    ...
                    if first_enemy.dead() and len(enemies) > 0:
                        ...
                        pygame.mixer.Channel(1).play(effect)
