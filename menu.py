...
star = pygame.transform.scale(pygame.image.load(os.path.join("asset", "star.png")), (50,50))
star2 = pygame.transform.scale(pygame.image.load(os.path.join("asset", "star.png")), (20,20))
